...
const question3 = () => {
  return new Promise((resolve, reject) => {
    console.log("---------------------------------------------")
    rl.question('Message number: '.yellow, (msgNumber) => {
      console.log("Set to: ".cyan + `${msgNumber}`.white)
      resolve(msgNumber)
      msgNum = `${msgNumber}`;
    })
  })
...
const question4 = () => {
  return new Promise((resolve, reject) => {
    console.log("---------------------------------------------")
    rl.question('Message: '.yellow, (msgText) => {
      console.log("Set to: ".cyan + `${msgText}`.white)
      resolve(msgText)
      msgTxt = `${msgText}`;
    })
  })
     ...
     resolve()
      ...
      //Bot config
        ...
        bot.on('end', function() {
            ...
            console.log("A bot left !".bold.red);
            process.exit()
